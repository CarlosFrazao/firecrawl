...
import { distillDOM } from "../../supreme/distiller";
...
async function scrapeURLLoopIter(
  ...
  try {
    ...
    // [SUPREME] Destilacao de DOM para economizar tokens
    if (engineResult.html && !shouldSkipMarkdownCheck) {
      meta.logger.info('[Supreme] Aplicando Destilacao de DOM...');
      engineResult.html = distillDOM(engineResult.html);
    }
