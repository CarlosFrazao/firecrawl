...
const createContext = async (skipTlsVerification: boolean = false, userAgentOverride?: string): Promise<{ context: BrowserContext; securityState: ContextSecurityState }> => {
  ...
  // Injeção de Stealth Avançado (Evita detecção de bots e WAFs)
  await newContext.addInitScript(() => {
    ...
    WebGLRenderingContext.prototype.getParameter = function(parameter) {
      ...
      if (parameter === 37446) return 'ANGLE (NVIDIA, NVIDIA GeForce GTX 1660 Ti Direct3D11 vs_5_0 ps_5_0, D3D11)';
    ...
    // Chrome Runtime Mocking e Plugins Overrides
